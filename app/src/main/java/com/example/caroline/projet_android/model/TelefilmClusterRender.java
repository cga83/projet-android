...
public class TelefilmClusterRender extends DefaultClusterRenderer<LieuxTournageClusterItem> {

    private final Context mContext;
    private final IconGenerator mClusterIconGenerator;

    public TelefilmClusterRender(Context context, GoogleMap map, ClusterManager<LieuxTournageClusterItem> clusterManager) {
    ...
    protected void onBeforeClusterItemRendered(LieuxTournageClusterItem item, MarkerOptions markerOptions) {
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.telefilm));
    }
